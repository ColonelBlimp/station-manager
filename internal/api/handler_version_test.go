...
func TestVersion_HappyPath(t *testing.T) {
	...
	// currently 14 (0001_init + 0002_relax_rst_length + 0003_allow_time_seconds +
	...
	// 0012_archive_identity + 0013_operator_event_archive + 0014_logbook_destination).
	if !strings.Contains(body, `"schema":{"version":14,"dirty":false}`) {
		t.Fatalf("body = %q, want schema:{version:14,dirty:false}", body)
	}
