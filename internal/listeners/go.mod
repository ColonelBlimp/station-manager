module github.com/ColonelBlimp/station-manager/internal/listeners
...
require (
	...
	github.com/ColonelBlimp/station-manager/internal/iocdi v0.0.0-00010101000000-000000000000
