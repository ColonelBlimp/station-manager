...
- **Next:** operator's on-screen tune check. W-0020 slices 1–4 (store, recorder, producing boundaries, API) built 2026-09-18; slice 5 (SPA) on direction. Open rulings: repeat-hold memory; landing view. Then G3/AC7 (per-occasion) or waive; start-failure visibility; Excel export; next freeze. RF per-occasion only; FT8-10 BLOCKED.
