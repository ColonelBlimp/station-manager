...
- **Goal:** W-0008 (harden audited contract boundaries). Slices 1–2 done+pushed; slice 3 alpha.2 done (AW-1's alpha.3 removal release-gated); slice 4 F-03+F-04a-c done (a/b pushed). [`backlog`](backlog.md) owns priority.
...
- **Next:** F-04c config re-read done; rig/FT8 confirm-by-push next. Run the alpha.3 removals as one coherent `v2.0.0-alpha.3` change. [`W-0017`](work/W-0017-deflake-bridge-sse-streaming-test.md) latent; W-0002 RF-gated.
