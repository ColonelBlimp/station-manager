...
- **Next:** operator's on-screen tune check. W-0020 slices 1–2 (store, recorder) built 2026-09-18; slice 3 (producing boundaries) on direction. Open rulings: repeat-hold memory; landing view. Then G3/AC7 (per-occasion) or waive; start-failure visibility; Excel export; next freeze. RF per-occasion only; FT8-10 BLOCKED.
