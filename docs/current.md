...
- **State:** station on `2.0.0-alpha.2-106-gdfd0898f` (deployed 2026-09-16: repeat-cap default 5, config line removed; alpha.2-97 carried the tune Mode-field fix, W-0012 AC2c). 2026-09-13: 150 QSOs, entry 40. 2026-09-14: 88 QSOs, entry 38; Map beside FT8 passive check met. 2026-09-15 soak: 309 QSOs, 835 rungs, 0 alarms → **W-0011 TX-alarm item CLOSED**, entry 39. **W-0020 Station Events SELECTED**, review package approved 2026-09-14.
- **Next:** operator's on-screen tune check. Operator reviews W-0020, then slice 1 (store). Ruled 2026-09-16 (inbox): RR73 kept; six small builds queued (ALC label, bag tooltip, Occupancy age, liveness warn-once, Settings cap field, W-0011 warn line). Open: repeat-hold memory; landing view. Then G3/AC7 (per-occasion) or waive; start-failure visibility; Excel export; next candidate freeze. RF only by per-occasion agreement; FT8-10 BLOCKED.
