...
- **Next:** operator's on-screen tune check. W-0020 slice 1 (store, migration 0009) built 2026-09-18; slice 2 (recorder) on direction. Open rulings: repeat-hold memory; landing view. Then G3/AC7 (per-occasion) or waive; start-failure visibility; Excel export; next freeze. RF per-occasion only; FT8-10 BLOCKED.
