...
- **Next:** operator's on-screen tune check. W-0020 all six slices built 2026-09-18; close-out awaits passive AC2 evidence (first real alarm rows on the page). Open rulings: repeat-hold memory; landing view. Then G3/AC7 (per-occasion) or waive; start-failure visibility; Excel export; next freeze. RF per-occasion only; FT8-10 BLOCKED.
