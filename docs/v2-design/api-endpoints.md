...
- **Errors:** 400 `invalid_json`/`ft8_tx_bad_message`; 503 `ft8_tx_unavailable`/`rig_not_ready`/`rig_dial_unknown`; 409 `ft8_tx_not_armed`/`ft8_tx_in_flight`; 500 `ft8_tx_failed`.
