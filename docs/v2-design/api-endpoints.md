...
- **Purpose:** Serve the embedded Svelte SPAs — app shell at `/app/` (ADR 0044), config app at `/config/`, logbook app at `/logbook/` — with client-side-routing fallback. `GET /` 302-redirects to `/app/`.
