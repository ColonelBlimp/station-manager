...
- **P2 · Logbook "Not emailed only" is page-local, so it looks inert.** _(dogfood
...
- **P2 · Session email — "send only not-yet-emailed" delta option.** _(dogfood
