...
| `internal/bridge/` | ✅ M3a.2 shipped (real serial+CAT pipeline replaces stub emitter; `mapStatusToPayload` field filter; 30s liveness disconnect; `fakeSerial` test seam) | M3a.3 adds bootstrap poll + bridge-error events |
