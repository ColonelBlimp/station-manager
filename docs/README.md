...
| [`../internal/bridge/AGENTS.md`](../internal/bridge/AGENTS.md) | Scoped bridge guidance: CAT pipeline, command and tune-controller boundaries, failure recovery, and RF-safety constraints. Inherited under `internal/bridge/`; its sibling `CLAUDE.md` is import-only. |
| [`../internal/ft8/AGENTS.md`](../internal/ft8/AGENTS.md) | Scoped FT8 kernel: TX and attribution invariants plus the sequencer-mode coordinated-edit checklist. Inherited under `internal/ft8/`; subsystem explanations stay in `ft8.md`. |
